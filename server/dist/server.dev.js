...
con.connect(function (err) {
  app.get('/getQuestions', function (req, res) {
    for (var i = 0; i < 10; i++) {
      var randomNumber = Math.floor(Math.random() * questionTotal) + 1;
      ...
      con.query(sql, function (err, result) {
        ...
        var T = Object.values(JSON.parse(JSON.stringify(result)));
        T.forEach(function (v) {
          return questions.push(v);
...
con.connect(function (err) {
  ...
  app.get('/getLeaderBoard', function (req, res) {
    ...
    */
    ...
    con.query(getLeaders, function (err, result) {
      ...
      var leaders = Object.values(JSON.parse(JSON.stringify(LBarr)));
      leaders.forEach(function (v) {
        return LB.push(v);
      });
      console.log(LB);
      res.send({
  ...
  app.post('/addLeader', function (req, res) {
    ...
    res.send("I received your POST request. This is what you sent me: ".concat(req.body.name));
  });
});
/*
const questions = [
